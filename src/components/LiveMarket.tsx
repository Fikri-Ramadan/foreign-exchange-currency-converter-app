...
export default function LiveMarket() {
  ...
  return (
    <div className="h-9 md:h-10 flex items-center">
      <div className="h-full bg-lime-500 text-neutral-500 px-2 md:px-4 flex items-center justify-center gap-2">
        ...
        <div className="text-[10px] md:text-xs text-neutral-950 font-bold tracking-wide">LIVE MARKETS</div>
      </div>
      {
        isValidating ?
