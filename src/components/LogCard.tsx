...
export default function LogCard({ id, createdAt, send, receive, sendAmount, receiveAmount }: LogConversion) {
  ...
  return (
    <div
      className="flex justify-between border border-neutral-400 bg-neutral-600 rounded-md p-4 tracking-wide hover:border-neutral-200/50 hover:cursor-pointer transition-colors duration-300 ease-in-out"
